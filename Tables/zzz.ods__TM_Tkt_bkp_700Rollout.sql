...
GO
CREATE NONCLUSTERED INDEX [IDX_BusinessKey] ON [zzz].[ods__TM_Tkt_bkp_700Rollout] ([acct_id], [plan_event_id], [ticket_status], [section_id], [row_id], [seat_num]) INCLUDE ([num_seats], [ssbPriceCode])
GO
...
GO
CREATE NONCLUSTERED INDEX [IDX_ticket_status_add_datetime] ON [zzz].[ods__TM_Tkt_bkp_700Rollout] ([ticket_status], [add_datetime]) INCLUDE ([block_purchase_price], [event_id], [event_name], [num_seats], [plan_event_id], [price_code], [Price_code_desc], [row_id], [seat_num], [section_id])
GO
CREATE CLUSTERED INDEX [Idx_upd_datetime_event_id] ON [zzz].[ods__TM_Tkt_bkp_700Rollout] ([upd_datetime], [acct_id], [event_id])
GO
