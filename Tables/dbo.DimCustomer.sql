...
GO
CREATE NONCLUSTERED INDEX [IX_TMAccount] ON [dbo].[DimCustomer] ([AccountId], [CustomerType], [SourceSystem])
GO
...
GO
CREATE NONCLUSTERED INDEX [ix_dimcustomer_ssid] ON [dbo].[DimCustomer] ([SSID]) INCLUDE ([DimCustomerId])
GO
ALTER TABLE [dbo].[DimCustomer] ADD CONSTRAINT [UK_SSID] UNIQUE NONCLUSTERED  ([SSID], [SourceSystem])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_UpdatedDate] ON [dbo].[DimCustomer] ([UpdatedDate])
GO
