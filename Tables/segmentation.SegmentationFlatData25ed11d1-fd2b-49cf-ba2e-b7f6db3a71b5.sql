CREATE TABLE [segmentation].[SegmentationFlatData25ed11d1-fd2b-49cf-ba2e-b7f6db3a71b5]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData25ed11d1-fd2b-49cf-ba2e-b7f6db3a71b5] ADD CONSTRAINT [pk_SegmentationFlatData25ed11d1-fd2b-49cf-ba2e-b7f6db3a71b5] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData25ed11d1-fd2b-49cf-ba2e-b7f6db3a71b5] ON [segmentation].[SegmentationFlatData25ed11d1-fd2b-49cf-ba2e-b7f6db3a71b5] ([_rn])
GO
