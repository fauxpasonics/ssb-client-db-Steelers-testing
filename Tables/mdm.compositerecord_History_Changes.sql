CREATE TABLE [mdm].[compositerecord_History_Changes]
(
[BatchDate] [date] NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecord_History_Changes_AccountID] ON [mdm].[compositerecord_History_Changes] ([AccountId])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecord_History_Changes_BatchDate] ON [mdm].[compositerecord_History_Changes] ([BatchDate])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecord_History_Changes_DimCustomerID] ON [mdm].[compositerecord_History_Changes] ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_CompositeRecord_History_Changes_SSID] ON [mdm].[compositerecord_History_Changes] ([SSID])
GO
