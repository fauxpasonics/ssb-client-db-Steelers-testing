CREATE TABLE [segmentation].[SegmentationFlatData9501cd89-b4d1-4e41-8476-876df03dbf8e]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData9501cd89-b4d1-4e41-8476-876df03dbf8e] ADD CONSTRAINT [pk_SegmentationFlatData9501cd89-b4d1-4e41-8476-876df03dbf8e] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData9501cd89-b4d1-4e41-8476-876df03dbf8e] ON [segmentation].[SegmentationFlatData9501cd89-b4d1-4e41-8476-876df03dbf8e] ([_rn])
GO
