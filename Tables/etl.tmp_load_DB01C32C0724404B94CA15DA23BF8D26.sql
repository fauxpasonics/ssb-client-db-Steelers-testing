CREATE TABLE [etl].[tmp_load_DB01C32C0724404B94CA15DA23BF8D26]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_DB01C32C0724404B94CA15DA23BF8D26_ss] ON [etl].[tmp_load_DB01C32C0724404B94CA15DA23BF8D26] ([SourceSystem], [SSID])
GO
