CREATE TABLE [archive].[dimcustomerssbid_bak_201605]
(
...
GO
CREATE CLUSTERED INDEX [CIX_dimcustomerssbid_bak_201605] ON [archive].[dimcustomerssbid_bak_201605] ([DimCustomerSSBID], [DimCustomerId], [NameAddr_ID], [NameEmail_id], [Composite_ID])
GO
