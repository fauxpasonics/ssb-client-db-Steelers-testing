CREATE TABLE [segmentation].[SegmentationFlatDatad0a17f8c-8870-49ef-95ca-92f4701c314d]
(
...
[Is_Concert_Event] [int] NOT NULL
)
GO
ALTER TABLE [segmentation].[SegmentationFlatDatad0a17f8c-8870-49ef-95ca-92f4701c314d] ADD CONSTRAINT [pk_SegmentationFlatDatad0a17f8c-8870-49ef-95ca-92f4701c314d] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatDatad0a17f8c-8870-49ef-95ca-92f4701c314d] ON [segmentation].[SegmentationFlatDatad0a17f8c-8870-49ef-95ca-92f4701c314d] ([_rn])
GO
