...
GO
CREATE NONCLUSTERED INDEX [IDX_IsAvailable_IsSaleable] ON [dbo].[FactInventoryHistory] ([IsAvailable], [IsSaleable])
GO
CREATE NONCLUSTERED INDEX [IDX_FactInventory_IsHeld] ON [dbo].[FactInventoryHistory] ([IsHeld])
GO
CREATE NONCLUSTERED INDEX [IDX_IsSold] ON [dbo].[FactInventoryHistory] ([IsSold])
GO
CREATE NONCLUSTERED INDEX [IX_FactInventory__ManifestDimPriceCodeId] ON [dbo].[FactInventoryHistory] ([ManifestDimPriceCodeId]) INCLUDE ([DimEventId], [DimSeasonId], [DimSeatId])
GO
CREATE NONCLUSTERED INDEX [IDX_FactoryInverntory_PostedDimPriceCodeId] ON [dbo].[FactInventoryHistory] ([PostedDimPriceCodeId])
GO
