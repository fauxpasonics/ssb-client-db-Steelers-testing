CREATE TABLE [ods].[Steelers_500f_Events]
(
...
GO
CREATE NONCLUSTERED INDEX [IX_Steelers_500f_Events_Loyalty_Customer_ID] ON [ods].[Steelers_500f_Events] ([loyalty_customer_id])
GO
