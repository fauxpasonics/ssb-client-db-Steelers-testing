CREATE TABLE [segmentation].[SegmentationFlatData4eaa8d6f-b4a3-48e1-a947-af16282a2e5a]
(
...
GO
ALTER TABLE [segmentation].[SegmentationFlatData4eaa8d6f-b4a3-48e1-a947-af16282a2e5a] ADD CONSTRAINT [pk_SegmentationFlatData4eaa8d6f-b4a3-48e1-a947-af16282a2e5a] PRIMARY KEY NONCLUSTERED  ([id])
GO
CREATE CLUSTERED INDEX [cix_SegmentationFlatData4eaa8d6f-b4a3-48e1-a947-af16282a2e5a] ON [segmentation].[SegmentationFlatData4eaa8d6f-b4a3-48e1-a947-af16282a2e5a] ([_rn])
GO
