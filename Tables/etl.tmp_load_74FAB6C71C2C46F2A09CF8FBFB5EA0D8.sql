CREATE TABLE [etl].[tmp_load_74FAB6C71C2C46F2A09CF8FBFB5EA0D8]
(
...
[FullName] [nvarchar] (4000) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
[AddressPrimaryZip] [nvarchar] (200) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
[AccountId] [int] NULL,
[IsBusiness] [int] NULL,
[customer_matchkey] [nvarchar] (265) COLLATE SQL_Latin1_General_CP1_CI_AS NOT NULL,
...
GO
CREATE NONCLUSTERED INDEX [ix_load_74FAB6C71C2C46F2A09CF8FBFB5EA0D8_ss] ON [etl].[tmp_load_74FAB6C71C2C46F2A09CF8FBFB5EA0D8] ([SourceSystem], [SSID])
GO
