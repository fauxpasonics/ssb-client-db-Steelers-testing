CREATE TABLE [etl].[tmp_load_AE86027A49B042BD88E4D186C0B81E13]
(
...
GO
CREATE NONCLUSTERED INDEX [ix_load_AE86027A49B042BD88E4D186C0B81E13_ss] ON [etl].[tmp_load_AE86027A49B042BD88E4D186C0B81E13] ([SourceSystem], [SSID])
GO
