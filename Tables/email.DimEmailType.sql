...
[CreatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Creat__2A533CC4] DEFAULT (getdate()),
[CreatedBy] [varchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
[UpdatedDate] [datetime] NULL CONSTRAINT [DF__DimEmailT__Updat__2B4760FD] DEFAULT (getdate()),
