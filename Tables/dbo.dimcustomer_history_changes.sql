CREATE TABLE [dbo].[dimcustomer_history_changes]
(
[BatchDate] [date] NULL,
...
[ExtAttribute10] [nvarchar] (100) COLLATE SQL_Latin1_General_CP1_CI_AS NULL,
...
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_History_Changes_AccountID] ON [dbo].[dimcustomer_history_changes] ([AccountId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_History_Changes_BatchDate] ON [dbo].[dimcustomer_history_changes] ([BatchDate])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_History_Changes_dimCustomerID] ON [dbo].[dimcustomer_history_changes] ([DimCustomerId])
GO
CREATE NONCLUSTERED INDEX [IX_DimCustomer_History_Changes_SSID] ON [dbo].[dimcustomer_history_changes] ([SSID])
GO
