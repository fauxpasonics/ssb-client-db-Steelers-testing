...
CREATE PROCEDURE [etl].[500f_LoadDimCustomer] 
...
DECLARE @Now NVARCHAR(25)

RAISERROR('start',0,1) WITH NOWAIT
SET @Now = CONVERT(nvarchar(25),GETDATE())

RAISERROR(@Now,0,1) WITH NOWAIT

select * 
INTO #SrcData
FROM [ods].[vw_500f_LoadDimCustomer]

RAISERROR('temp table srcData Loaded',0,1) WITH NOWAIT
SET @Now = CONVERT(nvarchar(25),GETDATE())
...
RAISERROR('srcData indexed',0,1) WITH NOWAIT
SET @Now = CONVERT(nvarchar(25),GETDATE())
...
(
	...
	RAISERROR('name loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('address primary loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('address one loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('address 2 loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('address 3 loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('address 4 loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone primary loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone home loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone cell loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone business loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone fax loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('phone other loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('email primary loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('email one loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('email two loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(nvarchar(25),GETDATE())
...
THEN UPDATE SET 
	...
	RAISERROR('ext  loaded',0,1) WITH NOWAIT
	SET @Now = CONVERT(NVARCHAR(25),GETDATE())
