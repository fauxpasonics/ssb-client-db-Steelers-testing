...
CREATE VIEW [ods].[vw_Yinzcam_LoadDimCustomer] AS (
...
--base set
		SELECT 
			...
			/*AddressPrimary*/
            , stg.AddressPrimaryStreet	AS [AddressPrimaryStreet]
			, stg.AddressPrimaryCity 	AS [AddressPrimaryCity] 
			, stg.AddressPrimaryState 	AS [AddressPrimaryState] 
			, stg.AddressPrimaryZip 	AS [AddressPrimaryZip] 
			, NULL	AS [AddressPrimaryCounty]
			, stg.AddressPrimaryCountry	AS [AddressPrimaryCountry] 
			...
			/*Phone*/
			, stg.PhonePrimary AS [PhonePrimary]
			, NULL AS [PhoneHome]
			, NULL AS [PhoneCell]
			...
			/*Email*/
			, stg.EmailPrimary AS [EmailPrimary]
			, NULL AS [EmailOne]
			, NULL AS [EmailTwo]
			...
			, NULL [SSCreatedBy]
			, NULL [SSUpdatedBy]
			, SSCreatedDate [SSCreatedDate]
			, GETDATE() [CreatedDate]
			, SSUpdatedDate [SSUpdatedDate]

			, NULL [AccountId]
			, NULL IsBusiness
			, 0 AS isdeleted
			, stg.Customer_matchkey AS Customer_Matchkey
--		select top 100 *
		FROM ods.vw_yinzcam_DimCustomer_stage stg
		WHERE 1=1
		AND SSUpdatedDate > DATEADD(DAY,-3,GETDATE())
	) a
