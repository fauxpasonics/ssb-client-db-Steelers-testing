...
CREATE VIEW [rpt].[vw_FactTicketSeat_Merch] AS (
...
LEFT OUTER JOIN dbo.FactTicketSales (NOLOCK) fts ON fi.FactTicketSalesId = fts.FactTicketSalesId
    ...
    LEFT OUTER JOIN dbo.DimCustomerMerch (NOLOCK) dc ON fi.SoldDimCustomerId = dc.DimCustomerMerchId
